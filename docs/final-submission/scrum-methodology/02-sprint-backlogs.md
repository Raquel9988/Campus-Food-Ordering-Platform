...
The sprint backlogs were also tracked using GitHub Projects. Each sprint had its own project board, which was used to organise backlog items, ready tasks, work in progress, review items, and completed work.
...
| S4-08 | Final submission documentation | Documentation | 5 | Completed project artefacts | Done |
...
The team also completed the final submission documentation and added the required supporting artefacts.

---

# Overall Sprint Backlog Summary

| Sprint | Main Goal | Main Deliverables | GitHub Project Board | Status |
|---|---|---|---|---|
| Sprint 1 | Build authentication and menu foundation | Login, registration, roles, menu management, admin controls | https://github.com/users/Raquel9988/projects/2 | Done |
| Sprint 2 | Build ordering workflow | Cart, orders, vendor dashboard, status tracking, notifications | https://github.com/users/Raquel9988/projects/4 | Done |
| Sprint 3 | Add payments and dietary system | PayFast, paid orders, dietary tags, dietary filtering | https://github.com/users/Raquel9988/projects/6 | Done |
| Sprint 4 | Add analytics and finalise project | Analytics reports, exports, final documentation | https://github.com/users/Raquel9988/projects/7 | Done |
